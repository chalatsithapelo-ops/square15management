...
import { deleteInvoice } from "~/server/trpc/procedures/deleteInvoice";
...
import {
  ohsAnalyzeRisks,
  ohsAnalyzeIncident,
  ohsGenerateToolboxTalk,
  ohsCreateRiskAssessment,
  ohsListRiskAssessments,
  ohsApproveRiskAssessment,
  ohsDeleteRiskAssessment,
  ohsExportRiskAssessmentPdf,
  ohsReportIncident,
  ohsListIncidents,
  ohsUpdateIncident,
  ohsAddCorrectiveAction,
  ohsExportIncidentPdf,
  ohsCreateToolboxTalk,
  ohsListToolboxTalks,
  ohsAcknowledgeToolboxTalk,
  ohsExportToolboxTalkPdf,
  ohsCreateDocument,
  ohsListDocuments,
  ohsUpdateDocument,
  ohsDeleteDocument,
  ohsAcknowledgeDocument,
...
import {
  ...
  recomputeScore,
} from "~/server/trpc/procedures/recruitmentAts";
import {
  createScorecard,
  getScorecards,
  submitScorecard,
...
} from "~/server/trpc/procedures/recruitmentEvaluation";
import {
  createOffer,
  approveOffer,
  sendOffer,
  ...
  declineOffer,
  listOffers,
} from "~/server/trpc/procedures/recruitmentOffers";
import {
  candidateDashboard,
  candidateSendMessage,
  candidateWithdraw,
  candidateGetInterviewQuestions,
  candidateSubmitInterviewAnswer,
  createTalentPool,
  listTalentPools,
  addToTalentPool,
  rediscoverCandidates,
  setDemographicProfile,
  requestDataDeletion,
  exportMyData,
  ...
  analyticsAdverseImpact,
  analyticsEEA,
  analyticsRecruiterDashboard,
} from "~/server/trpc/procedures/recruitmentExtras";
...
export const appRouter = createTRPCRouter({
  ...
  // Recruitment 2.0 — ATS (Jobs, Applications, Pipelines)
  createJob,
  updateJob,
  publishJob,
  closeJob,
  ...
  // Recruitment 2.0 — Evaluation (Scorecards, Interviews, Checks)
  createScorecard,
  getScorecards,
  submitScorecard,
  createInterviewPanel,
